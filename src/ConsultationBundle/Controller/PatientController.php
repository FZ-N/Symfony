...
use ConsultationBundle\Entity\Patient;
...
class PatientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $patients = $em->getRepository('ConsultationBundle:Patient')->findAll();
    ...
    {
        $patient = new Patient();
        $form = $this->createForm('ConsultationBundle\Form\PatientType', $patient);
    ...
    {
        $deleteForm = $this->createDeleteForm($patient);
        $editForm = $this->createForm('ConsultationBundle\Form\PatientType', $patient);
